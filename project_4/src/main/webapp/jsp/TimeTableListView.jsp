...
%>
		...
		<table width=fixed align="center">
			<tr>
				<td><label  >Course Name:</label><font style="background: green;"><%=HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), courseList) %></font>
